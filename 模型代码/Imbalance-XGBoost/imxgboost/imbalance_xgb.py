...
class imbalance_xgboost(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, data_x, data_y):
        ...
        train_data = data_x.iloc[train_ind] #本来没用iloc
        train_label = data_y.iloc[train_ind]
        valid_data = data_x.iloc[valid_ind]
        valid_label = data_y.iloc[valid_ind]
        # train_data = data_x[train_ind] #本来没用iloc
        # train_label = data_y.iloc[train_ind]
